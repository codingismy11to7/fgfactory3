...
var DATA = {
    ...
    scenarios:[
        //---
        {   id:'fto1', img:'img/fto1/', label:'fto1-', victoryReqs:{  },
            //---
            recipes:[
                //---
                ...
                //{	name:'armor',	reqs:{ 'mission-tank':1 },	machine:'assembler',	time:25,	output:1,	inputs:{ 'engine-2':40, 'low-density-structure':30, 'circuit-3':60 }	},
                //{	name:'artillery-wagon',	reqs:{ 'armor':1 },	machine:'assembler',	time:4,	output:1,	inputs:{ 'engine':64, 'gear':10, 'steel':40, 'pipe':16, 'circuit-2':20 }	},
                ...
                //{	name:'rocket-part',	reqs:{ 'spidertron':1 },	machine:'rocket-silo',	time:3,	output:1,	inputs:{ 'rocket-fuel':10, 'rocket-control-unit':10, 'low-density-structure':10 }	},
                //{	name:'satellite',	reqs:{ 'rocket-part':1 },	machine:'assembler-3',	time:5,	output:1,	inputs:{ 'accumulator':100, 'low-density-structure':100, 'circuit-3':100, 'radar':5, 'rocket-fuel':50, 'solar-panel':100 }	},
                ...
                //{	name:'spidertron',	reqs:{ 'artillery-wagon':1 },	machine:'assembler',	time:10,	inputs:{ 'exoskeleton':4, 'fusion-reactor':2, 'rocket-launcher':4, 'rocket-control-unit':16, 'low-density-structure':150, 'radar':2 }	},
                ...
                //---
                //{	name:'accumulator-tech',	reqs:{ 'rocket-part':1 },	machine:'lab',	time:30*150,	output:1,	inputs:{ 'red-pack':150, 'green-pack':150 }	},
                ...
                //{	name:'artillery',	reqs:{ 'military-4':1 },	machine:'lab',	time:30*2000,	output:1,	inputs:{ 'red-pack':2000, 'green-pack':2000, 'grey-pack':2000, 'blue-pack':2000, 'yellow-pack':2000 }	},
                ...
                //{	name:'automobilism',	reqs:{ 'mission-lab':1 },	machine:'lab',	time:30*100,	output:1,	inputs:{ 'red-pack':100, 'green-pack':100 }	},
                ...
                {	name:'explosives-tech',	reqs:{ 'sulfur-tech':1 },	machine:'lab',	time:15*100,	output:1,	inputs:{ 'red-pack':100, 'green-pack':100 }	},
                {	name:'flamethrower-tech',	reqs:{ 'flammables':1, 'grey-tech':1 },	machine:'lab',	time:30*50,	output:1,	inputs:{ 'red-pack':50, 'green-pack':50, 'grey-pack':50 }	},
                ...
                {	name:'gate-tech',	reqs:{ 'military-2':1, 'wall-tech':1 },	machine:'lab',	time:30*100,	output:1,	inputs:{ 'red-pack':100, 'green-pack':100 }	},
                ...
                {	name:'land-mine-tech',	reqs:{ 'explosives-tech':1, 'grey-tech':1 },	machine:'lab',	time:30*100,	output:1,	inputs:{ 'red-pack':100, 'green-pack':100, 'grey-pack':100 }	},
                ...
                {	name:'military-2',	reqs:{ 'military':1 },	machine:'lab',	time:15*20,	output:1,	inputs:{ 'red-pack':20, 'green-pack':20 }	},
                ...
                //{	name:'military-4',	reqs:{ 'explosives-tech':1, 'military-3':1, 'yellow-tech':1 },	machine:'lab',	time:45*150,	output:1,	inputs:{ 'red-pack':150, 'green-pack':150, 'grey-pack':150, 'blue-pack':150, 'yellow-pack':150 }	},
                ...
                {	name:'tank-tech',	reqs:{ 'explosives-tech':1, 'military-3':1 },	machine:'lab',	time:30*250,	output:1,	inputs:{ 'red-pack':250, 'green-pack':250, 'grey-pack':250, 'blue-pack':250 }	},
                {	name:'train-stop-tech',	reqs:{ 'railway':1 },	machine:'lab',	time:30*75,	output:1,	inputs:{ 'red-pack':75, 'green-pack':75 }	},
            ...
            items:[
                ...
                //{	id:'mission-armor',	cat:'objective',	recipeName:'mission-armor',	stack:1,	toComplete:true,	hasUnlocks:true,	desc:true	},
                ...
                //{	id:'automobilism',	cat:'tech',	recipeName:'automobilism',	stack:1,	hasUnlocks:true,	toComplete:true	},
                ...
                //{	id:'fusion-reactor-tech',	cat:'tech',	recipeName:'fusion-reactor-tech',	stack:1,	hasUnlocks:true,	toComplete:true	},
                ...
                //{	id:'spidertron-tech',	cat:'tech',	recipeName:'spidertron-tech',	stack:1,	hasUnlocks:true,	toComplete:true	},
                //{	id:'artillery',	cat:'tech',	recipeName:'artillery',	stack:1,	hasUnlocks:true,	toComplete:true	},                
                //{	id:'space-tech',	cat:'tech',	recipeName:'space-tech',	stack:1,	hasUnlocks:true,	toComplete:true	},
            ],
        }
    ]
}
