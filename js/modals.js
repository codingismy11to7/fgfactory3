    ...
    html += '<div id="modalScenario" class="modal fade">'
        html += '<div class="modal-dialog">'
            html += '<div class="modal-content">'
                ...
                html += '</div>'
                html += '<div class="modal-footer justify-content-center">'
                    html += '<button type="button" class="btn btn-warning" data-bs-dismiss="modal" onclick="window.app.changeScenario()">'
                        html += i18next.t('word-continue')
                    html += '</button>'
                html += '</div>'
            html += '</div>'
        html += '</div>'
