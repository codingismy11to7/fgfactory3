...
var TplToastExport = function() {
    ...
    html += '<div id="toastExport" class="toast align-items-center text-bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true">'
        html += '<div class="d-flex">'
            ...
            html += '</div>'
            html += '<button type="button" class="btn-close p-2" data-bs-dismiss="toast" aria-label="' + i18next.t('word-close') + '"><i class="text-black fas fa-times"></i></button>'
        html += '</div>'
    html += '</div>'
    //---
    return html
...
var TplToastImportEmpty = function() {
    ...
    html += '<div id="toastImportEmpty" class="toast align-items-center text-bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true">'
        html += '<div class="d-flex">'
            ...
            html += '</div>'
            html += '<button type="button" class="btn-close p-2" data-bs-dismiss="toast" aria-label="' + i18next.t('word-close') + '"><i class="text-white fas fa-times"></i></button>'
        html += '</div>'
    html += '</div>'
    //---
    return html
